...
export const Default = () => Vue.extend({
    ...
    computed: {
        data(): BarChartDataPoint<Date>[] {
            ...
            return [
                { x: DateTime.local(2020, 8, 1).toJSDate(), series: {redDelicious: 10, mcintosh: 15, oranges: 9, pears: 6 }},
                { x: DateTime.local(2020, 8, 2).toJSDate(), series: {redDelicious: 12, mcintosh: 18, oranges: 9, pears: 4 }},
                { x: DateTime.local(2020, 8, 3).toJSDate(), series: {redDelicious: 5, mcintosh: 20, oranges: 8, pears: 2 }},
                { x: DateTime.local(2020, 8, 4).toJSDate(), series: {redDelicious: 1, mcintosh: 15, oranges: 5, pears: 4 }},
                { x: DateTime.local(2020, 8, 5).toJSDate(), series: {redDelicious: 2, mcintosh: 10, oranges: 4, pears: 2 }},
                { x: DateTime.local(2020, 8, 6).toJSDate(), series: {redDelicious: 3, mcintosh: 12, oranges: 6, pears: 3 }},
