    ...
    <div v-if="processedContent" :class="['content-card', `type-${processedContent.contentType}`, {reflectScreen: isReflectScreen}]">
        <section class="content">
            ...
            <div class="grow-container" v-if="isReflectScreen">
                ...
                <!-- <svg class="grow5 meaning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43 122">
                    ...
                    <g class="stem2" fill="none" fill-rule="evenodd">
                ...
                <!-- <svg class="grow5 relationships" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 109 122">
                ...
                <!-- <svg class="grow5 emotions" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 62 121">
                    <g class="stem2">
                ...
                <svg class="grow5 experience" viewBox="0 0 69 122" xmlns="http://www.w3.org/2000/svg">
...
<script lang="ts">
    ...
    export default Vue.extend({
        ...
        computed: {
            ...
            // whichCactus(): string | undefined {
            //     let cactusElement = "" || CactusElement.meaning;
            //     switch (cactusElement) {
            //         case CactusElement.meaning:
            //             cactusElement = "meaning";
            //             break;
            //         case CactusElement.energy:
            //             cactusElement = "energy";
            //             break;
            //         case CactusElement.emotions:
            //             cactusElement = "emotions";
            //             break;
            //         case CactusElement.relationships:
            //             cactusElement = <svg class="grow5 relationships" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 109 122">
            //                 <path class="leaf1" fill="#29A389" d="M69.05 38.815C70.652 29.978 54.303.624 54.303.624s2.922 28.8-1.086 45.468l-1.977 9.852 6.773 19.291 11.147-26.611-.112-9.81z"/>
            //                 <path class="leaf2" fill="#07454C" d="M62.58 77.7C49.122 52.45 26.67 4.26 26.67 4.26s4.937 38.418 11.309 55.82c0 0 6.645 25.01 13.402 32.421l9.956 5.817 5.336-8.005L62.58 77.7z"/>
            //                 <path class="leaf2" fill="#07454C" d="M57.287 81.69C43.111 52.656.287 41 .287 41S33.335 68.822 37.43 83l19.857-1.31z"/>
            //                 <path class="leaf3" fill="#33CCAB" d="M64.082 64.063c9.227-13.545 23.273-23.87 39.034-28.495-1.772.967-23.058 20.26-30.395 38.13l-3.084 11.484-17.453 12.72 2.993-33.39 8.905-.449z"/>
