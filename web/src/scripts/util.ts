...
export function addModal(modalId: string, options: {
    ...
    const $button = createElementFromString(`<button title="Close" class="modal-close secondary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
